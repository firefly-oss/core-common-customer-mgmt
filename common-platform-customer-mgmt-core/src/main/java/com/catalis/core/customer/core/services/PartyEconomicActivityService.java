...
public interface PartyEconomicActivityService {
    /**
     * Filters the party economic activities based on the given criteria.
     *
     ...
     */
    Mono<PaginationResponse<PartyEconomicActivityDTO>> filterPartyEconomicActivities(FilterRequest<PartyEconomicActivityDTO> filterRequest);
    
    /**
     * Creates a new party economic activity based on the provided information.
     *
     ...
     */
    Mono<PartyEconomicActivityDTO> createPartyEconomicActivity(PartyEconomicActivityDTO partyEconomicActivityDTO);
     ...
     */
    Mono<PartyEconomicActivityDTO> updatePartyEconomicActivity(Long partyEconomicActivityId, PartyEconomicActivityDTO partyEconomicActivityDTO);
    
    /**
     * Deletes a party economic activity identified by its unique ID.
     *
     ...
     */
    Mono<Void> deletePartyEconomicActivity(Long partyEconomicActivityId);
    
    /**
     * Retrieves a party economic activity by its unique identifier.
     *
     ...
     */
    Mono<PartyEconomicActivityDTO> getPartyEconomicActivityById(Long partyEconomicActivityId);
}