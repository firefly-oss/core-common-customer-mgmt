...
public interface PoliticallyExposedPersonService {
    /**
     * Filters the politically exposed persons based on the given criteria.
     *
     ...
     */
    Mono<PaginationResponse<PoliticallyExposedPersonDTO>> filterPoliticallyExposedPersons(FilterRequest<PoliticallyExposedPersonDTO> filterRequest);
    
    /**
     * Creates a new politically exposed person based on the provided information.
     *
     ...
     */
    Mono<PoliticallyExposedPersonDTO> createPoliticallyExposedPerson(PoliticallyExposedPersonDTO politicallyExposedPersonDTO);
     ...
     */
    Mono<PoliticallyExposedPersonDTO> updatePoliticallyExposedPerson(Long politicallyExposedPersonId, PoliticallyExposedPersonDTO politicallyExposedPersonDTO);
    
    /**
     * Deletes a politically exposed person identified by its unique ID.
     *
     ...
     */
    Mono<Void> deletePoliticallyExposedPerson(Long politicallyExposedPersonId);
    
    /**
     * Retrieves a politically exposed person by its unique identifier.
     *
     ...
     */
    Mono<PoliticallyExposedPersonDTO> getPoliticallyExposedPersonById(Long politicallyExposedPersonId);
}