...
public interface NaturalPersonService {
    /**
     * Filters the natural persons based on the given criteria.
     *
     ...
     */
    Mono<PaginationResponse<NaturalPersonDTO>> filterNaturalPersons(FilterRequest<NaturalPersonDTO> filterRequest);
    
    /**
     * Creates a new natural person based on the provided information.
     *
     ...
     */
    Mono<NaturalPersonDTO> createNaturalPerson(NaturalPersonDTO naturalPersonDTO);
    
    /**
     * Updates an existing natural person with updated information.
     *
     ...
     */
    Mono<NaturalPersonDTO> updateNaturalPerson(Long naturalPersonId, NaturalPersonDTO naturalPersonDTO);
    
    /**
     * Deletes a natural person identified by its unique ID.
     *
     ...
     */
    Mono<Void> deleteNaturalPerson(Long naturalPersonId);
    
    /**
     * Retrieves a natural person by its unique identifier.
     *
     ...
     *         or an empty Mono if the natural person does not exist
     */
    Mono<NaturalPersonDTO> getNaturalPersonById(Long naturalPersonId);
}