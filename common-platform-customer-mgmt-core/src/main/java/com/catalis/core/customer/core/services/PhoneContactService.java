...
public interface PhoneContactService {
     ...
     */
    Mono<PaginationResponse<PhoneContactDTO>> filterPhoneContacts(Long partyId, FilterRequest<PhoneContactDTO> filterRequest);
     ...
     */
    Mono<PhoneContactDTO> createPhoneContact(Long partyId, PhoneContactDTO phoneContactDTO);
     ...
     */
    Mono<PhoneContactDTO> updatePhoneContact(Long partyId, Long phoneContactId, PhoneContactDTO phoneContactDTO);
     ...
     */
    Mono<Void> deletePhoneContact(Long partyId, Long phoneContactId);
     ...
     */
    Mono<PhoneContactDTO> getPhoneContactById(Long partyId, Long phoneContactId);
}